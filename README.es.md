...
| Paquete | Descripción |
|---|---|
| [**SAGITARI-Setup-3.2.1.exe**](https://github.com/dario90vlc/sagitari/releases/download/v3.2.1/SAGITARI-Setup-3.2.1.exe) | Instalador con accesos directos y desinstalador |
| [**SAGITARI-Portable-3.2.1.exe**](https://github.com/dario90vlc/sagitari/releases/download/v3.2.1/SAGITARI-Portable-3.2.1.exe) | Ejecutable único, sin instalación |
| [**Notas de la versión**](https://github.com/dario90vlc/sagitari/releases/tag/v3.2.1) | Cambios, correcciones de seguridad y hashes SHA-256 |
...
El workflow de release ejecuta la comprobación de sintaxis, tests, smoke, UI, compilación de los dos artefactos de Windows, verificación de archivos y generación de hashes SHA-256. El tag debe coincidir con la versión de `package.json`; para esta release es `v3.2.1`.
