...
| Artefacto | Qué es |
|---|---|
| `SAGITARI-Setup-2.2.1.exe` | Instalador Windows (NSIS): accesos directos, desinstalador |
| `SAGITARI-Portable-2.2.1.exe` | Portable: un solo ejecutable, sin instalación |
