...
| Artefacto | Qué es |
|---|---|
| `SAGITARI-Setup-2.2.0.exe` | Instalador Windows (NSIS): accesos directos, desinstalador |
| `SAGITARI-Portable-2.2.0.exe` | Portable: un solo ejecutable, sin instalación |
