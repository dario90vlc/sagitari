...
`Windows 10/11` · `Electron` · `Multi-proveedor` · `MIT License`
...
- **Multi-proveedor (OpenAI-compatible):** OpenCode Go, OpenRouter, Ollama, LM Studio, Groq,
...
- **Chat + voz:** escribe o habla (dictado offline de Windows) y SAGITARI responde en voz alta (TTS).
...
- El agente las aplica automáticamente cuando detectan la tarea, o tú puedes forzarlas desde el
...
│   ├── preload.js
│   ├── providers.js
│   └── voice.ps1   # dictado offline (System.Speech)
...
- El dictado usa los reconocedores de voz de Windows; si falla, agrega el paquete de idioma en
  Configuración → Hora e idioma → Voz.
- Skills desbloqueadas de comunidad: cualquier repo con carpetas que contengan `SKILL.md` funciona.
