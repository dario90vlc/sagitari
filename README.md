...
| Package | Description |
|---|---|
| [**SAGITARI-Setup-3.0.1.exe**](https://github.com/dario90vlc/sagitari/releases/download/v3.0.1/SAGITARI-Setup-3.0.1.exe) | Installer with shortcuts and uninstaller |
| [**SAGITARI-Portable-3.0.1.exe**](https://github.com/dario90vlc/sagitari/releases/download/v3.0.1/SAGITARI-Portable-3.0.1.exe) | Single executable, no installation |
| [**Release notes**](https://github.com/dario90vlc/sagitari/releases/tag/v3.0.1) | Changes, security fixes, and SHA-256 hashes |
...
The release workflow runs syntax checks, tests, smoke, UI checks, builds both Windows artifacts, verifies the output, generates release notes, and publishes SHA-256 hashes. The release tag must match the version in `package.json` — for this release, `v3.0.1`.
